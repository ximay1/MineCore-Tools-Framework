...
public:
	...
	FORCEINLINE MiningToolClass* GetMiningTool() { return CachedMiningTools.Contains(MiningToolClass::StaticClass()) ? Cast<MiningToolClass>(*CachedMiningTools.Find(MiningToolClass::StaticClass())) : nullptr; }
